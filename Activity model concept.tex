...
\Cref{expmap} shows the exposure assessed using the proposed simulation model for the 49 university students. It can be observed that high exposures do not necessarily occur for people with high concentrations at the front door home locations.
